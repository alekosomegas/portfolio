...
export default function Footer() {
  return (
    <footer>
      ...
      <div
        className="bg-secondary grid grid-cols-3 gap-8 px-8 text-sm py-4
            max-md:flex max-md:flex-col-reverse max-md:text-center"
      >
        <div className="tracking-wider text-xs">
          <p>©2023 ALEXANDROS KANGKELIDIS</p>
        </div>
        <div className="flex justify-center gap-3 text-mainHighlight">
          ...
          <Link
            ...
            href="https://github.com/alekosomegas/portfolio"
        ...
        <div className="text-xs text-justify pl-6">
          <p>
            Sketched on Paper, Designed in Photoshop, coded in VSC. Built with
