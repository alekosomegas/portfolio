    ...
    >
      <div className="flex px-20 gap-10 items-top pt-16 max-md:flex-col max-md:pt-0 max-md:gap-4 max-md:px-8">
        <div className="pr-10 w-1/2 max-md:w-full">
          ...
          <p className="mb-8 w-2/3 max-md:w-full">
        ...
        <form
          ...
          className="text-black w-1/2 p-4 max-md:w-full"
          action=""
        >
          <div>
            <label
              className="not-sr-only text-secondaryHighlight"
              htmlFor="name"
            >
              NAME
            </label>
          ...
          <div className="mt-2 flex">
            <button
              ...
              className={`flex justify-center 
               duration-700 rounded-sm bg-mainHighlight px-8 py-4 font-medium text-secondaryHighlight uppercase w-full`}
            >
              {isLoading ? (
                <img
                  className="animate-send self-center"
                  src="/icons/mail.png"
                  width={32}
                  alt="email-icon"
                />
      ...
      <div className="snap-end">
        ...
        <div className="text-[8px] p-3 bg-secondary flex mzx-md:flex-col">
          ...
          <a
            href="https://www.flaticon.com/free-icons/internet"
            title="internet icons"
          >
          ...
          <a href="https://www.flaticon.com/free-icons/mail" title="mail icons">
            Mail icons created by Stockio - Flaticon
          </a>
        </div>
      </div>
    </section>
